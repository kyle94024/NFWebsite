...
var PreviewService = class {
   ...
   * @throws ApiError
   */
  listProjectsConsumption(cursor, limit = 10, from, to) {
    return this.httpRequest.request({
      method: "GET",
...
var ProjectService = class {
   ...
   * @throws ApiError
   */
  listProjects(cursor, limit = 10, search) {
    return this.httpRequest.request({
      method: "GET",
      url: "/projects",
      query: {
   ...
   * @throws ApiError
   */
  listSharedProjects(cursor, limit = 10, search) {
    return this.httpRequest.request({
      method: "GET",
      url: "/projects/shared",
      query: {
   ...
   * @throws ApiError
   */
  grantPermissionToProject(projectId, requestBody) {
    return this.httpRequest.request({
      method: "POST",
      url: "/projects/{project_id}/permissions",
      path: {
   ...
   * @throws ApiError
   */
  revokePermissionFromProject(projectId, permissionId) {
    return this.httpRequest.request({
      method: "DELETE",
